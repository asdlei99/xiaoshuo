...
if(!($commu = read_cache('commu',$arc->channel['cuid']))) message('noavailableitemoper');
if(!$commu['available'] || $commu['cclass'] != 'answer') message('noavailableitemoper');
...
if(!($tplname = @$commu['cutpl'])) message('defineanslisttem');
$arc->detail_data();
$_da = &$arc->archive;
arc_parse($_da);

$_mp = array();
$_mp['durlpre'] = $cms_abs.'answers.php?aid='.$arc->aid.'&page={$page}';
$_mp['static'] = 0;
