...
<h1>最近更新</h1>
<?php $_lianzailist_m=_ctag_parse(array("ename" => "lianzailist_m","tclass" => "archives","disabled" => "0","limits" => "7","caidson" => "1","casource" => "1","caids" => "1","space" => "1","ucsource" => "1","closed" => "-1","abover" => "-1",));foreach($_lianzailist_m as $v){_aenter($v);?>
<dl>
...
</dl><?php _aquit();} unset($_lianzailist_m,$v);?>
