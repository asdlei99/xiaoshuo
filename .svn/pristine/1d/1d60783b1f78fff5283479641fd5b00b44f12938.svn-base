...
$lic_str = empty($cmsinfos['lic_str']) ? lang('lic_uk') . ' <a href="http://www.xiaoshuo.com" target="_blank" class="cRed">' . lang('lic_by') . '</a>' : lang('lic_no') . $cmsinfos['lic_str'].'<a href="http://www.xiaoshuo.com" target="_blank" class="cRed">' . lang('lic_ck') . '</a>';
...
<div class="area">
    ...
    <div class="nav1">
        <font class=" left f24px"><?=lang('welcome_platform')?></font><font class="right"></font>	
    </div>
