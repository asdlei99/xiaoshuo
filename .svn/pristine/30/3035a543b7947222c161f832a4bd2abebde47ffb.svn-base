...
$(function(){
	...
	if(ind==0 || ind==3 || ind==5) $('.tagdhnew_02').css({'height':'0','overflow':'hidden'});
});
</script>
<!--  -->
<div id="menu">
	<div class="tagdhnew_01">
		<div class="left">
			<ul>
				...
				<li onmouseover="showmenu(1)"><a title="男频" href="<?php $v=_ctag_parse(array("ename" => "xs_menunode","tclass" => "cnode","listby" => "ca","casource" => "1",));if(!empty($v)){_aenter($v);?>
<?=$v['indexurl']?><?php _aquit();} unset($v);?>
">男频</a></li>
				<li onmouseover="showmenu(6)"><a title="女频" href="<?php $v=_ctag_parse(array("ename" => "xs_nvpinnode","tclass" => "cnode","disabled" => "0","listby" => "ca","casource" => "14",));if(!empty($v)){_aenter($v);?>
		<?=$v['indexurl']?><?php _aquit();} unset($v);?>
">女频</a></li>
...
<a href="<?=$v['indexurl']?>"><?=$v['title']?></a><?php _aquit();} unset($v);?>
				...
				<li onmouseover="showmenu(3)"><a title="排行榜" href="<?php $v=_ctag_parse(array("ename" => "pai_index","tclass" => "cnode","disabled" => "0","listby" => "ca","casource" => "1","cosource7" => "38","urlmode" => "caid",));if(!empty($v)){_aenter($v);?>
	            <?=$v['indexurl']?><?php _aquit();} unset($v);?>
">排行榜</a></li>
...
<div class="center">
    <div class="centerl">
    	<ul>
        <?php $_webdibu=_ctag_parse(array("ename" => "webdibu","tclass" => "farchives","limits" => "10","cols" => "1","casource" => "11","orderby" => "vieworder_desc",));foreach($_webdibu as $v){_aenter($v);?>
<li><a href="<?=$v['arcurl']?>" id="on<?=$v['aid']?>"><?php echo _utag_parse(array("ename" => "subject30","tclass" => "odeal","tname" => "$v[subject]","trim" => "30",));?>
</a></li><?php _aquit();} unset($_webdibu,$v);?>
