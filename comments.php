...
if(!$arc->channel['comment'] || !($commu = read_cache('commu',$arc->channel['comment']))) message('setcomitem');
...
if(!($tplname = @$commu['cutpl'])) message('definecomlisttem');//未定义评论模板
$arc->detail_data();
$_da = &$arc->archive;
arc_parse($_da);

$_mp = array();
$_mp['durlpre'] = $cms_abs.'comments.php?aid='.$arc->aid.'&page={$page}';
$_mp['static'] = 0;
