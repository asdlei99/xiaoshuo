...
switch($url_type){
	...
	case 'repus':
		$urlsarr = array(
		'grade' => array(lang('repugrade'),"?entry=repugrades$param_suffix"),
		'record' => array(lang('repurecord'),"?entry=repus&action=repusedit$param_suffix"),
		'hand' => array(lang('hand_repu'),"?entry=repus&action=repuadd$param_suffix"),
		);
	break;
	case 'mtdetail':
		$urlsarr = array(
	...
	case 'channeldetail':
		...
		'adv' => array(lang('advsetting'),"?entry=channels&action=channeladv&chid=$chid$param_suffix"),
		);
	break;
	case 'cnode';
		$urlsarr = array(
