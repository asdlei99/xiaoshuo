...
if(empty($submitmode)){
	...
	trbasic(lang('arange').lang('adopt_state'),'',makeradio('murlnew[setting][checked]',$checkedarr,!isset($murl['setting']['checked']) ? '-1' : $murl['setting']['checked']),'');
	tabfooter();
	...
	$murlnew['url'] = "?action=answers&nmuid=$muid";
}
?>