...
<style type="text/css">#nav .oncaid{background:#fff;text-decoration:none;color:#800000}</style>
<body>
<div id="wrap">
<div id="header">
...
<div id="left">
  <dl>
    <dt>推荐文章</dt><dd><?php $_space_rec=_ctag_parse(array("ename" => "space_rec","tclass" => "archives","limits" => "10","cols" => "1","closed" => "-1","abover" => "-1",));foreach($_space_rec as $v){_aenter($v);?>
...
<br /><br /></dd></dl>
<dl><dt>统计信息</dt><dd><?php $v=_ctag_parse(array("ename" => "member_info2","tclass" => "userinfos","usource" => "1",));if(!empty($v)){_aenter($v);?>
文档：<?=$v['archives']?>篇<br />评论：<?=$v['comments']?>篇<br />信息：<?=$v['freeinfos']?>篇<br />网币：<?=$v['currency2']?>个<br /><br /><?php _aquit();} unset($v);?>
</dd></dl>
</div>
<div id="container">
...
<h1>最近更新章节</h1>
<?php $_space_new_file=_ctag_parse(array("ename" => "space_new_file","tclass" => "archives","limits" => "7","cols" => "1","nochids" => "1","space" => "1","closed" => "-1","abover" => "-1",));foreach($_space_new_file as $v){_aenter($v);?>
<dl>
...
</dl><?php _aquit();} unset($_space_new_file,$v);?>
