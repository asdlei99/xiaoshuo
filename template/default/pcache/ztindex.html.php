...
<div>还没做好</div>
<div class="findivbox">
<div class="findivtop"><img src="<?=$tplurl?>images/ico_hsg.gif" align="absmiddle" /><b>推介专题</b></div>
...
<div class="fincon">
    ...
    <div class="ficontxt">
        <ul>
            ...
            <li class="fincozz"><strong>作者：<?=$v['author']?></strong></li>
            <li class="fincojj"><strong>简介：</strong><?php echo _utag_parse(array("ename" => "hotindex_abs_180","tclass" => "odeal","disabled" => "0","tname" => "$v[abstract]","dealhtml" => "clearhtml","trim" => "180","wordlink" => "1","nl2br" => "1",));?>
</li>
        </ul>
    </div>
...
<div id="divboxd">
<div id="lm4"><dl>
<dt><img src="<?=$tplurl?>images/ico_gx.gif"  align="absmiddle" /><b>最新专题列表</b>&nbsp;&nbsp;<a href="<?=$listurl?>"><font style="color:#F00;">更多&gt;&gt;</font></a></dt>
